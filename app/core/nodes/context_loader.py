"""Context loader node — repository analysis and issue hydration."""
...
from ._helpers import _progress_meta
...
logger = get_logger("core.nodes.context_loader")
...
def context_loader_node(state: GraphState) -> dict:
    ...
    _daedalus_root = Path(__file__).parent.parent.parent.parent.resolve()
