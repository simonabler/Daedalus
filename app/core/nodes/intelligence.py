"""Code intelligence node — static analysis, call graph, dependency graph, code smells."""
...
from ._context_format import _extract_language

logger = get_logger("core.nodes.intelligence")
