"""Router node — intent classification gate."""
...
from app.core.task_routing import is_programming_request, parse_issue_ref
...
logger = get_logger("core.nodes.router")
...
def router_node(state: GraphState) -> dict:
    ...
    _router_prompt_file = Path(__file__).parent.parent.parent / "agents" / "prompts" / "router.txt"
